...
public class C01_Alerts {
    ...
    public void test01(){
        ...
        //Alert't ok a basin ve result kisminda "You successfully clicked an alert" yazdigini test edin

        String expectedResult="You successfully clicked an alert";
        WebElement actualResult=driver.findElement(By.xpath("//*[text()='You successfully clicked an alert']"));
